...
public class NetworkExample3 {
    ...
    private NetworkExample3() {
        ...
        for (int i = 0; i < 2; i++) { //two datacenters
            datacenterList.add(createDatacenter());
        }

        for (int i = 0; i < 2; i++) { //two brokers
    ...
    private void createNetwork() {
        ...
        BriteNetworkTopology networkTopology = BriteNetworkTopology.getInstance("./Simulations/topology.brite");
